...
pub enum FormationEffect {
    ...
    SummonSpirit,
    ClearEnvironment,
    DamagePreviousTeamByLevelSumTimes { multiplier: u32 },
    HalvePreviousTeamHp,
    DamageNextTeamAndTakeHighestLevelHandCard { damage: u32 },
    PerformResidualAndSelectedResonance,
    PerformAllFiveResonanceEffects,
    PreventOtherPlayersFromActingOrDrawing { duration_turns: u32 },
    GainDivineCalculationProtection,
    PoisonNextPlayer { duration_turns: u32 },
    DamageNextTeamAndPoisonNextPlayer { damage: u32, duration_turns: u32 },
    WinIfNextTeamHpAtMost { hp_threshold: u32 },
    ChangeEnvironment,
    BreakProfession,
    LimitedUseRecovery,
