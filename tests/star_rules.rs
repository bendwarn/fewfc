...
use fewfc::domain::{
    CardInstanceId, Command, CoveredPassive, Element, FiveStarAlignment, GameEvent, GameOutcome,
    GameSetup, GameState, GameStatus, PassiveTriggerTiming, Phase, Player, PlayerId,
    PlayerStarHistory, RuleModuleId, STAR_MODULE_ID, StarBreakReason, StarKind, TeamId, TeamStar,
};
